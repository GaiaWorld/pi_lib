...
use ecs::{Component, MultiCaseImpl, SingleCaseImpl, Runner, MultiCaseListener,
          SingleCaseListener, EntityListener, CreateEvent, ModifyEvent,
          DeleteEvent, LendMut, World, SeqDispatcher, Dispatcher};
...
impl ::std::fmt::Debug for Position {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        match *self {
            Position { x: ref __self_0_0, y: ref __self_0_1 } => {
...
impl <'a> MultiCaseListener<'a, Node, Position, CreateEvent> for SystemDemo {
    ...
    fn listen(&mut self, event: &CreateEvent, read: Self::ReadData,
              _write: Self::WriteData) {
...
impl <'a> MultiCaseListener<'a, Node, Position, ModifyEvent> for SystemDemo {
    ...
    fn listen(&mut self, event: &ModifyEvent, read: Self::ReadData,
              _write: Self::WriteData) {
...
impl <'a> MultiCaseListener<'a, Node, Position, DeleteEvent> for SystemDemo {
    ...
    fn listen(&mut self, event: &DeleteEvent, read: Self::ReadData,
              _write: Self::WriteData) {
...
impl <'a> SingleCaseListener<'a, View, ModifyEvent> for SystemDemo {
    ...
    ReadData
    =
    &'a SingleCaseImpl<View>;
    type
    WriteData
    =
    ();

    fn listen(&mut self, _event: &ModifyEvent, read: Self::ReadData,
              _write: Self::WriteData) {
...
impl <'a> EntityListener<'a, Node, CreateEvent> for SystemDemo {
    ...
    fn listen(&mut self, event: &CreateEvent, _read: Self::ReadData,
              _write: Self::WriteData) {
...
impl <'a> EntityListener<'a, Node, DeleteEvent> for SystemDemo {
    ...
    fn listen(&mut self, event: &DeleteEvent, _read: Self::ReadData,
              _write: Self::WriteData) {
...
impl CellSystemDemo<> {
    pub fn new(sys: SystemDemo<>) -> Self {
        Self{owner: ::ecs::cell::StdCell::new(sys),
             run_fn: None,
...
impl ::ecs::system::System for CellSystemDemo<> {
    fn get_depends(&self)
     ->
        ...
        let r_ids =
            <<<SystemDemo<> as
              ::ecs::system::MultiCaseListener<'_, Node, Position,
                                               CreateEvent>>::ReadData as
             ::ecs::system::SystemData>::FetchTarget as
                ::ecs::TypeIds>::type_ids();
        let w_ids =
            <<<SystemDemo<> as
              ::ecs::system::MultiCaseListener<'_, Node, Position,
                                               CreateEvent>>::WriteData as
        ...
        let r_ids =
            <<<SystemDemo<> as
              ::ecs::system::MultiCaseListener<'_, Node, Position,
                                               DeleteEvent>>::ReadData as
             ::ecs::system::SystemData>::FetchTarget as
                ::ecs::TypeIds>::type_ids();
        let w_ids =
            <<<SystemDemo<> as
              ::ecs::system::MultiCaseListener<'_, Node, Position,
                                               DeleteEvent>>::WriteData as
             ::ecs::system::SystemMutData>::FetchTarget as
                ::ecs::TypeIds>::type_ids();
        read_ids.extend_from_slice(&r_ids);
        write_ids.extend_from_slice(&w_ids);
    ...
    fn setup(&mut self, me: std::sync::Arc<::ecs::system::System>,
             world: &::ecs::world::World, name: &Atom) {
        let me: std::sync::Arc<Self> =
            match ::ecs::system::System::downcast(me) {
                Ok(r) => r,
                Err(_) => {
					panic!("");
        ...
        let f =
            ::ecs::monitor::FnListener(share::Share::new(move |e|
                                                             {
                                                                 let read_data =
                                                                     ::ecs::Lend::lend2(&read,
                                                                                        &read_data);
                                                                 let write_data =
                                                                     ::ecs::LendMut::lend_mut2(&write,
                                                                                               &write_data);
                                                                 <SystemDemo<>
                                                                     as
                                                                     ecs::MultiCaseListener<'_,
                                                                                            Node,
                                                                                            Position,
                                                                                            CreateEvent>>::listen(me1.borrow_mut1(),
                                                                                                                  e,
                                                                                                                  read_data,
                                                                                                                  write_data);
                                                             }));
        ...
        let ptr: (usize, usize) =
            unsafe { std::mem::transmute(share::Share::into_raw(f.0)) };
        listen_arr.push(ptr);
        let me1 = me.clone();
        let read =
            <<<SystemDemo<> as
            ...
            ::ecs::monitor::FnListener(share::Share::new(move |e|
                                                             {
                                                                 ...
                                                                 <SystemDemo<>
                                                                     ...
                                                                     ecs::MultiCaseListener<'_,
                                                                                            Node,
                                                                                            Position,
                                                                                            DeleteEvent>>::listen(me1.borrow_mut1(),
                                                                                                                  e,
                                                                                                                  read_data,
                                                                                                                  write_data);
                                                             }));
            ...
            ::ecs::monitor::FnListener(share::Share::new(move |e|
                                                             {
                                                                 ...
                                                                 <SystemDemo<>
                                                                     ...
                                                                     ecs::MultiCaseListener<'_,
                                                                                            Node,
                                                                                            Position,
                                                                                            ModifyEvent>>::listen(me1.borrow_mut1(),
                                                                                                                  e,
                                                                                                                  read_data,
                                                                                                                  write_data);
                                                             }));
        ...
        let runtime_ref =
            unsafe {
                &mut *(runtime.as_ref() as *const Vec<::ecs::RunTime> as
                           *mut Vec<::ecs::RunTime>)
            };
        let runtime_index = runtime_ref.len();
        runtime_ref.push(::ecs::RunTime{sys_name: name.clone(),
                                        cost_time:
                                            std::time::Duration::from_millis(0),});
        self.run_fn =
            Some(::ecs::monitor::FnListener(share::Share::new(move |e: &()|
                                                                  {
                                                                      let runtime_ref =
                                                                          unsafe
                                                                          {
                                                                      ...
                                                                      let write_data =
                                                                          ::ecs::LendMut::lend_mut2(&write,
                                                                                                    &write_data);
                                                                      me.borrow_mut1().run(read_data,
                                                                                           write_data);
                                                                      runtime_ref[runtime_index].cost_time
                                                                          =
                                                                          std::time::Instant::now()
                                                                              -
                                                                              time;
                                                                  })));
        self.dispose_listener_fn =
            Some(::ecs::monitor::FnListener(share::Share::new(move
                                                                  |world:
                                                                       &::ecs::world::World|
                                                                  {
                                                                      let setup_target =
                                                                          world.fetch_multi::<Node,
                                                                                              Position>().unwrap();
                                                                      let r:
                                                                              Box<Fn(&CreateEvent)> =
                                                                          unsafe
                                                                          {
                                                                              std::mem::transmute((&listen_arr[0]).clone())
                                                                          };
                                                                      let r:
                                                                              ::ecs::monitor::FnListener<CreateEvent> =
                                                                          ::ecs::monitor::FnListener(unsafe
                                                                                                     {
                                                                                                         share::Share::from_raw(Box::into_raw(r))
                                                                                                     });
                                                                      ::ecs::monitor::Notify::remove_create(&*setup_target,
                                                                                                            &r);
                                                                      let setup_target =
                                                                          world.fetch_multi::<Node,
                                                                                              Position>().unwrap();
                                                                      let r:
                                                                          ...
                                                                          unsafe
                                                                          {
                                                                              std::mem::transmute((&listen_arr[0
                                                                                                                   +
                                                                                                                   1]).clone())
                                                                          };
                                                                      let r:
                                                                              ::ecs::monitor::FnListener<DeleteEvent> =
                                                                          ::ecs::monitor::FnListener(unsafe
                                                                                                     {
                                                                                                         share::Share::from_raw(Box::into_raw(r))
                                                                                                     });
                                                                      ::ecs::monitor::Notify::remove_delete(&*setup_target,
                                                                                                            &r);
                                                                      let setup_target =
                                                                          world.fetch_multi::<Node,
                                                                                              Position>().unwrap();
                                                                      ...
                                                                      let r:
                                                                              ::ecs::monitor::FnListener<ModifyEvent> =
                                                                          ::ecs::monitor::FnListener(unsafe
                                                                                                     {
                                                                                                         share::Share::from_raw(Box::into_raw(r))
                                                                                                     });
                                                                      ::ecs::monitor::Notify::remove_modify(&*setup_target,
                                                                                                            &r);
                                                                      let setup_target =
                                                                          world.fetch_single::<View>().unwrap();
                                                                      let r:
                                                                              Box<Fn(&ModifyEvent)> =
                                                                          unsafe
                                                                          {
                                                                      ...
                                                                      ::ecs::monitor::Notify::remove_modify(&*setup_target,
                                                                                                            &r);
                                                                      let setup_target =
                                                                          world.fetch_entity::<Node>().unwrap();
                                                                      let r:
                                                                              Box<Fn(&CreateEvent)> =
                                                                          unsafe
                                                                          {
