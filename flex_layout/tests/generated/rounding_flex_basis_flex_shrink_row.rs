...
fn rounding_flex_basis_flex_shrink_row() {
    ...
    layout_tree.insert(
        ...
        layout::style::Style {
            size: layout::geometry::Size {
                width: layout::style::Dimension::Points(101f32),
    ...
    layout_tree.insert(
        ...
        layout::style::Style {
            flex_shrink: 1f32,
            flex_basis: layout::style::Dimension::Points(100f32),
            ..Default::default()
        },
    );
    layout_tree.insert(
        ...
        layout::idtree::InsertType::Back,
        layout::style::Style {
            flex_basis: layout::style::Dimension::Points(25f32),
            ..Default::default()
        },
    );
    layout_tree.insert(
    ...
    assert_eq!(layout.rect.end - layout.rect.start, 101f32);
    ...
    assert_eq!(layout.rect.end - layout.rect.start, 67f32);
    assert_eq!(layout.rect.bottom - layout.rect.top, 100f32);
    assert_eq!(layout.rect.start, 0f32);
    assert_eq!(layout.rect.top, 0f32);
    let layout = layout_tree.get_layout(4).unwrap();
    assert_eq!(layout.rect.end - layout.rect.start, 17f32);
    assert_eq!(layout.rect.bottom - layout.rect.top, 100f32);
    assert_eq!(layout.rect.start, 67f32);
    assert_eq!(layout.rect.top, 0f32);
    let layout = layout_tree.get_layout(5).unwrap();
    assert_eq!(layout.rect.end - layout.rect.start, 17f32);
    assert_eq!(layout.rect.bottom - layout.rect.top, 100f32);
    assert_eq!(layout.rect.start, 84f32);
    assert_eq!(layout.rect.top, 0f32);
}
