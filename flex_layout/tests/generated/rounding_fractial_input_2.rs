...
fn rounding_fractial_input_2() {
    ...
    layout_tree.insert(
        ...
        layout::style::Style {
            ...
            size: layout::geometry::Size {
                ...
                height: layout::style::Dimension::Points(113.6f32),
                ..Default::default()
            },
            ..Default::default()
        },
    ...
    assert_eq!(layout.rect.start, 0f32);
    assert_eq!(layout.rect.top, 65f32);
