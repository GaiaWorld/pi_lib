...
fn margin_should_not_be_part_of_max_height() {
    ...
    layout_tree.insert(
        ...
        layout::style::Style {
            size: layout::geometry::Size {
                width: layout::style::Dimension::Points(250f32),
                height: layout::style::Dimension::Points(250f32),
                ..Default::default()
            },
            ..Default::default()
        },
    ...
    assert_eq!(layout.rect.end - layout.rect.start, 250f32);
    assert_eq!(layout.rect.bottom - layout.rect.top, 250f32);
