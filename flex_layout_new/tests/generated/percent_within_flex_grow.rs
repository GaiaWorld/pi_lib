...
fn percent_within_flex_grow() {
    ...
    layout_tree.insert(
        ...
        layout::style::Style {
            size: layout::geometry::Size {
                width: layout::style::Dimension::Points(350f32),
    ...
    layout_tree.insert(
        ...
        layout::style::Style {
            size: layout::geometry::Size {
                width: layout::style::Dimension::Percent(1f32),
                ..Default::default()
            },
            ..Default::default()
        },
    ...
    assert_eq!(layout.rect.end - layout.rect.start, 350f32);
    ...
    assert_eq!(layout.rect.end - layout.rect.start, 150f32);
    assert_eq!(layout.rect.bottom - layout.rect.top, 100f32);
